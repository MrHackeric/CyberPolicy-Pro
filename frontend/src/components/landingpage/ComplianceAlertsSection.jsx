      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6" data-aos="fade-right">
            <h2 className="text-4xl font-bold text-white">Stay Ahead of Compliance Risks</h2>
            <p className="text-gray-200 text-lg">
              With CyberPolicy Pro, you can rest easy knowing you're always in compliance. Our platform monitors regulatory changes and sends timely alerts, so you can focus on running your business.
            </p>
          </div>
