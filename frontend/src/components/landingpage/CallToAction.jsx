    ...
    <section className="animated-bg py-16 text-center text-white">
      <div className="container mx-auto px-4">
        <div className="mb-8" data-aos="fade-down">
          <h2 className="text-4xl font-bold">Simplify Your Compliance Today</h2>
          <p className="mt-4 text-lg max-w-2xl mx-auto text-gray-200">
            Join hundreds of businesses using CyberPolicy Pro to streamline compliance management and stay ahead of regulatory changes.
          </p>
        </div>
